...
async def stream(
    ...
    if streamtype == "playlist":
        ...
        for search in result:
            ...
            if await is_active_chat(chat_id):
                ...
                # Store VIDEO ID instead of temporary URL.
                # This allows fresh URL extraction later.
                await put_queue(
                    chat_id,
                    original_chat_id,
                    f"vid_{vidid}",
    ...
    # =========================================================
        ...
        # IMPORTANT:
        # NO DOWNLOAD HERE
        # Resolve direct YouTube media URL only.
        # -----------------------------------------------------
