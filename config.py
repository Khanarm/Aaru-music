...
YTPROXY_URL = getenv("YTPROXY_URL", 'https://FallenApiBot.com') ## xBit Music Endpoint.
...
AUTO_LEAVING_ASSISTANT = getenv("AUTO_LEAVING_ASSISTANT", "True").strip().lower() in {"1", "true", "yes", "on"}
